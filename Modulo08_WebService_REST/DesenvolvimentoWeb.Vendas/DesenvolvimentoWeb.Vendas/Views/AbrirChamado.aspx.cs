...
namespace DesenvolvimentoWeb.Vendas.Views
{
	public partial class AbrirChamado : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			if (!IsPostBack)
			{
				assuntoDropDownList1.Items.Add("RECLAMAÇÃO");
				assuntoDropDownList1.Items.Add("SUGESTÃO");
				assuntoDropDownList1.Items.Add("ELOGIOS");
				assuntoDropDownList1.Items.Add("TROCAS");
				assuntoDropDownList1.Items.Add("DÚVIDAS");
			}
		}
		...
		protected async void enviarButton_Click(object sender, EventArgs e)
		{
			try
			{
				...
				chamado.Assunto = assuntoDropDownList1.SelectedValue;
